...
//    private BaseStatusBar mStatusBar;
    private TicautoStatusBar mTicautoStatusBar;
...
//        if (DEBUG) Log.d(TAG, "onServiceStartAttempt mStatusBar="+mStatusBar);
        Log.d(TAG, "onServiceStartAttempt mTicautoStatusBar="+mTicautoStatusBar);
//        if (mStatusBar != null) {
...
//        }
        if (mTicautoStatusBar != null) {
            // tear down the in-process version, we'll recreate it again if needed
            mTicautoStatusBar.destroy();
            mTicautoStatusBar = null;
            return WAIT_FOR_BARS_TO_DIE;
        }
        return 0;
    }
...
//        }
        if (mTicautoStatusBar != null) {
            mTicautoStatusBar.onConfigurationChanged(newConfig);
        }
    }
...
//        final String clsName = mContext.getString(R.string.config_statusBarComponent);
        final String clsName = "com.android.systemui.statusbar.TicautoStatusBar";
...
//        if (DEBUG) Log.d(TAG, "started " + mStatusBar.getClass().getSimpleName());
        try {
            mTicautoStatusBar = (TicautoStatusBar) cls.newInstance();
        } catch (Throwable t) {
            throw andLog("Error creating status bar component: " + clsName, t);
        }
        mTicautoStatusBar.mContext = mContext;
        mTicautoStatusBar.mComponents = mComponents;
        mTicautoStatusBar.start();
        Log.d(TAG, "started " + mTicautoStatusBar.getClass().getSimpleName());
//        if (DEBUG) Log.d(TAG, "started " + mTicautoStatusBar.getClass().getSimpleName());
    }
